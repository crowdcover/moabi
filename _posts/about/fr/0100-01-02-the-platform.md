...
Rechercher des informations détaillées sur l'utilisation des terres de RDC via une carte interactive. Exporter une carte telle une copie, une url ou [télécharger](http://planet.osm.moabi.org/extracts/) des données géographiques brutes. Si vous souhaitez faire part de vos propres données, [contactez-nous](mailto:info@moabi.org) et nous vous montrerons comment faire cela.
...
En savoir [plus](mailto:info@moabi.org) sur Moabi, ou [téléchargez et collaborez](http://planet.osm.moabi.org/extracts/) aux données.
